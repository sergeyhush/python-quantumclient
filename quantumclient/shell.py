...
COMMAND_V2 = {
    ...
    'policy-profile-list': utils.import_class('quantumclient.quantum.v2_0.policy_profile.ListPolicyProfile'),
    'policy-profile-show': utils.import_class('quantumclient.quantum.v2_0.policy_profile.ShowPolicyProfile'),
    }
